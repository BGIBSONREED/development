...
#         no_a_in_students.append(s) # add item to our empty list
...
# num1 = '5'
# num2 = '5' #when adding strings together it puts the name together it makes 55

# #if you use it as an integer it makes 10
...
# for m in my_list:
#   m = str(m) # changes integer to a string
#   if m not in new_string:   
#     new_string += m #cant add an int to a string..added in line above for code to work
#     print(new_string)
